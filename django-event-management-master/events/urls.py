...
urlpatterns = [
    ...
    path('add-event-wish-users/', AddEventUserWishListCreateView.as_view(), name='add-event-wish-users'),
    path('event-users-wish/<int:pk>/remove/', RemoveEventUserWishDeleteView.as_view(), name='remove-event-users-wish'),
    ...
    path('absense-users/', AbsenseUserList.as_view(), name='absense-users'),
    path('complete-event-users/', CompleteEventUserList.as_view(), name='complete-event-users'),
    path('create-users-mark/', CreateUserMark.as_view(), name='create-users-mark'),
    path('users-mark/', UserMarkList.as_view(), name='users-mark'),
